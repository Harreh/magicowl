...
function dlstrs_setup() {
    ...
    */
    ...
    } else add_theme_support( 'title-tag' );
}
...
function dlstrs_the_breadcrumbs() {    
    ...
    elseif ( is_day() ) {
        ...
        <div class="dlstrs-breadcrumbs-title"><?php echo __( 'Daily Archives:', 'daily-stories' ) . '&nbsp;'; the_time( 'd M Y' ); ?></div>
    <?php } 
    elseif ( is_month() ) {
        echo __( 'Archive', 'daily-stories' ); ?>
        <div class="dlstrs-breadcrumbs-title"><?php echo __( 'Monthly Archives:', 'daily-stories' ) . '&nbsp;'; the_time( 'M Y' ); ?></div>
    <?php } 
    elseif ( is_year() ) {
        echo __( 'Archive', 'daily-stories' ); ?>
        <div class="dlstrs-breadcrumbs-title"><?php echo __( 'Yearly Archives:', 'daily-stories' ) . '&nbsp;'; the_time( 'Y' ); ?></div>
    <?php }     
    elseif ( is_search() ) {
        echo __( 'Search Results', 'daily-stories' ); ?>    
        <div class="dlstrs-breadcrumbs-title"><?php echo __( 'For:', 'daily-stories' ) . '&nbsp;' . get_search_query(); ?></div>
    <?php } 
    elseif ( is_404() ) { 
...
function dlstrs_title( $title, $sep ) {
    ...
    if ( 2 <= $paged || 2 <= $page ) // Add a page number if necessary.
        $title = "$title $sep " . sprintf( __( 'Page', 'daily-stories' ) . '&nbsp;%s', max( $paged, $page ) );
    return $title;
}
/**
