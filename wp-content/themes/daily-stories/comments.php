...
<div id="comments" class="comments-area">
	<?php if ( have_comments() ) { ?>
		<h2 class="comments-title">
			<?php printf( _n( __( 'One thought on', 'daily-stories' ) . '&nbsp&ldquo;%2$s&rdquo;', '%1$s&nbsp;' . __( 'thoughts on', 'daily-stories' ) . '&nbsp&ldquo;%2$s&rdquo;', get_comments_number(), 'daily-stories' ), number_format_i18n( get_comments_number() ), '<span>' . get_the_title() . '</span>' ); ?>
		</h2><!-- .comments-title -->
