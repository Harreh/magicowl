		...
		<footer class="dlstrs-site-footer">
			...
			<div class="dlstrs-bottom">
				<div class="dlstrs-copyright">
					<p><?php echo __( 'Designed with love by', 'daily-stories' ) . '&nbsp;'; ?><a href="<?php echo esc_url( wp_get_theme()->get( 'AuthorURI' ) ); ?>">BestWebSoft</a><?php echo '&nbsp;' . __( 'and', 'daily-stories' ) . '&nbsp;'; ?><a href="<?php echo esc_url( 'http://wordpress.org/' ); ?>" target="_blank">WordPress</a><?php echo '&nbsp;&copy;&nbsp;' . date( 'Y' ) . '&nbsp;'; ?><a href="<?php echo esc_url( home_url() ); ?>"><?php bloginfo( 'name' ); ?></a></p>
